...
class CreateRegularCollectingFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = View.inflate(context, R.layout.fragment_create_regular_collecting, null)
        ...
        collecting.type = CollectingTypes.REGULAR_TYPE
        initListeners()
        return v
    }
